...
Format: **sca**le [*panel name* [*min value* *max value*] [_**frac**tion_]]
...
If the _**frac**tion_ argument is supplied, either with or without *min value*
...
Format: **tsys** [_**off**/**cor**relator/**comp**uted_]
